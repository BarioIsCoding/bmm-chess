/* PolyGlot Zobrist keys, fixed by the .bin book format. Layout: [0..767]
   64 * ((type - 1) * 2 + colour) + square, colour 0 = black; [768..771]
   castling; [772..779] en passant file; [780] white to move. */

#ifndef BMM_CHESS_POLYGLOT_KEYS_H
#define BMM_CHESS_POLYGLOT_KEYS_H

#include <stdint.h>

#define POLYGLOT_KEY_COUNT 781

static const uint64_t POLYGLOT_KEYS[POLYGLOT_KEY_COUNT] = {
...
#endif /* BMM_CHESS_POLYGLOT_KEYS_H */
